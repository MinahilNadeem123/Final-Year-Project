...
<div class="container">
    ...
    @endif
    <form class="row g-3 needs-validation container" autocomplete="off" id="form" style="padding:50px" action="{{route('updatePatient')}}" method="post" enctype="multipart/form-data" novalidate>
        @csrf
        ...
        <div class="col-md-3">
            ...
            <input id="myInput1" class="cr_no form-control" type="text" name="cr_no" value="{{$data->cr_no}}">
        ...
        <div class="col-md-3">
            ...
            <input type="text"  name="date_of_registration" value="{{$data->created_at->toDateString()}}" class="form-control" id="dor">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="time_of_registration" VALUE="{{$data->created_at->toTimeString()}}" class="form-control"  >
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="national_id"  class="nationalId form-control" value="{{$data->national_id}}" id="myInput">
            <span class="text-danger">@error('cnic'){{ $message }}@enderror</span>
        </div>
        <div class="col-md-3">
            <label for="first_name " class="form-label">Patient Name</label>
            <input type="text" name="first_name" class="first_name form-control" value="{{$data->first_name}}" id="first_name">
        ...
        <div class="col-md-3">
            ...
            <input type="date" name="birth_date" class="dob form-control" value="{{$data->birth_date}}" id="dob">
            <span class="text-danger">@error('dob'){{ $message }}@enderror</span>
        </div>
        <div class="col-md-3">
            <label for="Age " class="form-label">Age</label>
            <input type="text" name="age" class="age form-control" value="{{$data->age}}" id="Age">
        ...
        <div class="col-md-3">
            ...
            <select id="inputState" name="gender" class="gender form-select">
                ...
                <option value="male"  {{$data->gender == $data->gender ? 'selected' : ''}}>Male</option>
                <option value="female"  {{$data->gender == $data->gender ? 'selected' : ''}}>Female</option>
        ...
        <div class="col-md-3">
            ...
            <select id="inputState" name="marital_status" class="marital_status form-select">
                ...
                <option value="married"  {{$data->marital_status == $data->marital_status ? 'selected' : ''}}>Married</option>
                <option value="single"  {{$data->marital_status == $data->marital_status ? 'selected' : ''}}>Single</option>
        ...
        <div class="col-8">
            ...
            <input type="text" name="address_detail" class="address_detail form-control" value="{{$data->address_detail}}" id="inputAddress5" placeholder="Details">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="mobile_no_1" class="mobile_no_1 form-control" value="{{$data->mobile_no_1}}" id="MobileNumber1">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="mobile_no_2" class="mobile_no_2 form-control" value="{{$data->mobile_no_2}}" id="MobileNumber2">
        </div>
        <div class="col-md-3">
            <label for="MobileNumber3" class="form-label">Mobile Number 3</label>
            <input type="text" name="mobile_no_3" class="mobile_no_3 form-control" value="{{$data->mobile_no_3}}" id="MobileNumber3">
        </div>
        <div class="col-md-3">
            <label for="Whatsapp" class="form-label">Whatsapp Number</label>
            <input type="text" name="whatsapp_number" class="whatsapp_number form-control" value="{{$data->whatsapp_number}}" id="Whatsapp">
            <span class="text-danger">@error('whatsapp_number'){{ $message }}@enderror</span>
        </div>
        <div class="col-md-3">
            <label for="email" class="form-label">Email</label>
            <input type="email" name="email" class="email form-control" value="{{$data->email}}" id="email">
        </div>
        <div class="col-md-3">
            <label for="dor" class="form-label">Profession</label>
            <input type="text" name="profession" value="{{$data->profession}}" class="profession form-control" id="dor">
            <span class="text-danger">@error('profession'){{ $message }}@enderror</span>
        </div>
        <div class="col-md-3">
            <label for="tor" class="form-label">Profession Designation</label>
            <input type="text" name="professional_designation" value="{{$data->professional_designation}}" class="professional_designation form-control" id="tor">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="professional_address" value="{{$data->professional_address}}" class="professional_address form-control" id="inputCNIC4">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="native_language" value="{{$data->native_language}}" class="native_language form-control" id="inputPatient Name4">
...
{{--        </div>--}}
        ...
        <div class="col-12 mb-5 mx-lg-auto" style="align-self: center;">
            <button type="submit" class="btn btn-success btn-lg" style="margin-left: 47%;">Update</button>
        </div>
