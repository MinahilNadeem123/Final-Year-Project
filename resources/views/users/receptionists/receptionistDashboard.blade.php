...
<h1 style="text-align: center; font-size: 48px;padding-bottom: 1%;color:white;margin-top: 2%; background-color: rgb(0, 0, 0);">Receptionist Dashboard</h1><br>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div style="margin-left:200px">
        <a href="{{route('patientForm')}}" style="background-color:rgb(231, 236, 236);color:black;height:125px; width:300px;" class="btn   btn-lg btn-font-lg " role="button" aria-pressed="true">
            <h4 style="margin:40px">Add Patient</h4></a>
        &nbsp &nbsp &nbsp
        <a href="{{url('appointments/create')}}" style="height:125px; width:300px;background-color:rgb(231, 236, 236);color:black" class="btn  btn-lg btn-font-lg " role="button" aria-pressed="true">
            <h4 style="margin:40px">Add Appointment</h4></a>
        &nbsp &nbsp &nbsp
        <a href="{{route('RPatientsList')}}" style="background-color:rgb(231, 236, 236);color:black;height:125px; width:300px;" class="btn   btn-lg btn-font-lg " role="button" aria-pressed="true">
            <h4 style="margin:40px">Patients List</h4></a>
        &nbsp &nbsp &nbsp
       <br><br>
