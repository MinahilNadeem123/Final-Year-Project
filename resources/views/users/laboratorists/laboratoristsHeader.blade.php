                    ...
                    <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-tab ">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                ...
                                <a href="{{route('laboratoristDashboard')}}" class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-text">Dashboard</span></a>
                            </li>
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                                <a href="{{route('addTest')}}" class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-text">Add Test</span></a>
                            </li>
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                                <a href="{{route('testList')}}" class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-text">Test List</span></a>
                            </li>
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                                <a href="{{route('labPatientList')}}" class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-text">Patient Test List</span></a>
                            </li>
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                data-ktmenu-submenu-toggle="click" aria-haspopup="true">
