...
<div class="container">
    <form  class="row g-3">
        ...
        <div class="col-6" style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="Middle">Middle aged</label>
            ...
            <label class="form-check-label" for="Adolescent">Adolescent</label>
        ...
        <div class="col-6"style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="With">With average Built</label>
            ...
            <label class="form-check-label" for="Morbidly">Morbidly</label>
            <input class="form-check-input" type="checkbox" value="" id="Emaciated">
            <label class="form-check-label" for="Emaciated">Emaciated</label>
            <input class="form-check-input" type="checkbox" value="" id="Empty2">
            <label class="form-check-label" for="Empty2">Empty</label>
        </div>
        <div class="col-6">
        ...
        <div class="col-6"style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="Lyingoncouch">Lying on couch</label>
            <input class="form-check-input" type="checkbox" value="" id="Sittingin">
            <label class="form-check-label" for="Sittingin">Sitting in wheelchair</label>
            <input class="form-check-input" type="checkbox" value="" id="lyingno">
            <label class="form-check-label" for="lyingno">lying no Stretcher</label>
            <input class="form-check-input" type="checkbox" value="" id="Empty3">
            <label class="form-check-label" for="Empty3">Empty</label>
        </div>
        <div class="col-6">
        ...
        <div class="col-6"style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="Empty4">Empty</label>
        </div>
        <div class="col-6">
        ...
        <div class="col-6"style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="Central">Central Venous Catheter</label>
            <input class="form-check-input" type="checkbox" value="" id="Double">
            <label class="form-check-label" for="Double">Double Lumen Catheter</label>
            <input class="form-check-input" type="checkbox" value="" id="Hemodilysis">
            <label class="form-check-label" for="Hemodilysis">Hemodilysis Catheter</label>
            <input class="form-check-input" type="checkbox" value="" id="4">
            <label class="form-check-label" for="4">4</label>
            <input class="form-check-input" type="checkbox" value="" id="5">
            <label class="form-check-label" for="5">5</label>
        ...
        <div class="col-6"style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="RightInternal">Right Internal Jugular</label>
            <input class="form-check-input" type="checkbox" value="" id="LeftInternal">
            <label class="form-check-label" for="LeftInternal">Left Internal Jugular</label>
            <input class="form-check-input" type="checkbox" value="" id="RightSubclavian">
            <label class="form-check-label" for="RightSubclavian">Right Subclavian</label>
            <input class="form-check-input" type="checkbox" value="" id="LeftSubclavian">
            <label class="form-check-label" for="LeftSubclavian">Left Subclavian</label>
            <input class="form-check-input" type="checkbox" value="" id="RightFemoral">
            <label class="form-check-label" for="RightFemoral">Right Femoral</label>
        ...
        <div>
            <div class="col-6" >
                <label for="AVFistula"  class="form-label">AV Fistula Present</label>
        ...
        <div class="col-6"style="margin-top: 50px;">
            <input class="form-check-input" type="checkbox" value="" id="OnRightarm">
            <label class="form-check-label" for="OnRightarm">On Right arm</label>
            <input class="form-check-input" type="checkbox" value="" id="OnLeftarm">
            <label class="form-check-label" for="OnLeftarm">On Left arm </label>
        </div>
        <div>
        ...
        <div class="col-6"style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="Greenish">Greenish</label>
            ...
            <label class="form-check-label" for="Coffeeground">Coffee ground </label>
            <input class="form-check-input" type="checkbox" value="" id="BrightRed">
            <label class="form-check-label" for="BrightRed">Bright Red </label>
        </div>
        <div>
            <div class="col-6">
                <label for="FoleysinPlace" class="form-label">Foleys in Place</label>
        ...
        <div class="col-6"style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="urinTransparent">Transparent</label>
            <input class="form-check-input" type="checkbox" value="" id="urinYellow">
            <label class="form-check-label" for="urinYellow">Pale Yellow </label>
            <input class="form-check-input" type="checkbox" value="" id="urindark">
            <label class="form-check-label" for="urindark">Dark Yellow</label>
            <input class="form-check-input" type="checkbox" value="" id="urinorange">
            <label class="form-check-label" for="urinorange">Orange</label>
            <input class="form-check-input" type="checkbox" value="" id="urinbrown">
            <label class="form-check-label" for="urinbrown">Brown </label>
            ...
            <label class="form-check-label" for="urinblack">Black</label>
            <input class="form-check-input" type="checkbox" value="" id="urinblue">
            <label class="form-check-label" for="urinblue">Blue</label>
            <input class="form-check-input" type="checkbox" value="" id="uringreen">
            <label class="form-check-label" for="uringreen">Green</label>
            <input class="form-check-input" type="checkbox" value="" id="urinBrown">
            <label class="form-check-label" for="urinBrown">Purple</label>
            <input class="form-check-input" type="checkbox" value="" id="urinWhite">
            <label class="form-check-label" for="urinWhite">White</label>
        </div>
        <div>
            <div class="col-6">
        ...
        <div class="col-6"style="margin-top: 50px;">
            ...
            <label class="form-check-label" for="Whitish">Whitish</label>
            <input class="form-check-input" type="checkbox" value="" id="Yellowish">
            <label class="form-check-label" for="Yellowish">Yellowish </label>
            <input class="form-check-input" type="checkbox" value="" id="urindark">
            <label class="form-check-label" for="spGreenish">Greenish</label>
            <input class="form-check-input" type="checkbox" value="" id="Browniah">
            <label class="form-check-label" for="Browniah">Browniah</label>
            <input class="form-check-input" type="checkbox" value="" id="Blackish">
            <label class="form-check-label" for="Blackish">Blackish</label>
            <input class="form-check-input" type="checkbox" value="" id="StreaksofBlood">
            <label class="form-check-label" for="StreaksofBlood">Streaks of Blood</label>
            <input class="form-check-input" type="checkbox" value="" id="Frankblood">
            <label class="form-check-label" for="Frankblood">Frank blood</label>
        </div>
