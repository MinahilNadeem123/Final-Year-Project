...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div style="margin-left:200px">
        <a href="{{route('nurseDashboard')}}" style="background-color:rgb(231, 236, 236);color:black;height:125px; width:300px;" class="btn   btn-lg btn-font-lg " role="button" aria-pressed="true">
            <h4 style="margin:40px">Dashboard</h4></a>
        &nbsp &nbsp &nbsp
        <a href="{{route('nursingParameters')}}" style="height:125px; width:300px;background-color:rgb(231, 236, 236);color:black" class="btn  btn-lg btn-font-lg " role="button" aria-pressed="true">
            <h4 style="margin:40px">Nursing Parameters</h4></a>
        &nbsp &nbsp &nbsp
        <a href="{{route('riskFactorsList')}}" style="background-color:rgb(231, 236, 236);color:black;height:125px; width:300px;" class="btn   btn-lg btn-font-lg " role="button" aria-pressed="true">
            <h4 style="margin:40px">Risk Factors</h4></a>
        &nbsp &nbsp &nbsp
        <br><br>
