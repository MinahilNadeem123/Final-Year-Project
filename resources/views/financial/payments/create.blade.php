                    ...
                    <div class="col-md-6">
                        <div class="kt-portlet kt-portlet--height-fluid">
                            ...
                            <div class="kt-portlet__foot">
                                ...
                                <p style="float:right; font-size:24px;">RS<span id="totalprice"></span></p>
...
@section('scripts')
    <script src="{{asset('adminpanel/assets/js/demo3/pages/dashboard.js')}}" type="text/javascript"></script>
                ...
                addEvent: function (value) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $("#cart tbody").append('<tr id="' + value + '"><input id="DC' + value + '" type="hidden" name="doctor_commission' + value + '" value="' + jsonar[0].commission + '"><input type="hidden" name="item' + value + '" value="' + value + '"><input type="hidden" id="totalitem' + value + '" name="total' + value + '"><td><a href="#" class="kt-widget11__title">' + jsonar[0].name + '</a></td><td class="kt-align-right">RS<span id="price' + value + '">' + jsonar[0].price + '</span></td><td><div class="input-group bootstrap-touchspin bootstrap-touchspin-injected"><input type="number" id="qty' + value + '" class="form-control qtynum" value="1" name="qty' + value + '" min="1"><span class="input-group-btn-vertical"><button onclick="this.parentNode.parentNode.querySelector(\'input[type=number]\').stepUp()" class="btn btn-secondary bootstrap-touchspin-up" type="button"><i class="la la-plus"></i></button><button onclick="this.parentNode.parentNode.querySelector(\'input[type=number]\').stepDown()" class="btn btn-secondary bootstrap-touchspin-down" type="button"><i class="la la-minus"></i></button></span></div></td><td class="kt-align-right kt-font-brand kt-font-bold">RS<span id="total' + value + '">' + jsonar[0].price + '</span></td></tr>');
                        }
                    });
